...
public class SongGenerator {
    ...
    private static SongComponent generate(){
        ...
        Song stepOn = new Song("Step On", "Happy Mondays", 1990,"resource/music/Happy Mondays - Step On.mp3");
        Song foolsGold = new Song("Fool,s Gold", "Stone Roses", 1989, "resource/music/The Stone Roses - Fool's Gold.mp3");
        ninetiesDance.add(stepOn);
        ninetiesDance.add(foolsGold);
        Song crazy = new Song("Crazy", "Gnarls Barkley", 2006,"resource/music/Gnarls Barkley - Crazy.mp3");
